...
Industrial and Systems Engineers, 2018.)</p></li>
   ...
   <hr>
              <h2>Working Papers</h2>
      	      <ol>
                      <li><p>Chen, D., Mykland, P.A., and Zhang, L. (2018). <a href = "https://ssrn.com/abstract=3118039" target = "_blank">The Five Trolls under the Bridge: Principal Component Analysis with Asynchronous and Noisy High Frequency Data</a>. (submitted.) </p></li>
              </ol>        
   <hr>
               <p>[<a href = "https://business.uic.edu/faculty/dachuan-chen" target = "_blank">Dachuan's Webpage at Liautaud Graduate School of Business, UIC</a>]</p>
